...
When the resulting raster is read by software such as GDAL or QGIS, these *nodata* areas may be interpreted as a value of 0, causing the minimum elevation to be **incorrect**.<br>  
This means the height range used to create the heightmap will not be accurate.<br> 
